...
#else
					btClosestNotMeConvexResultCallback sweepResults(body,body->getWorldTransform().getOrigin(),predictedTrans.getOrigin(), m_broadphasePairCache->getOverlappingPairCache(),getDispatcher());
#endif
