...
//void btConvexShape::project(const btTransform& trans, const btVector3& dir, btScalar& minProj, btScalar& maxProj, btVector3& witnesPtMin, btVector3& witnesPtMax) const
//{
//	btVector3 localAxis = dir*trans.getBasis();
//	btVector3 vtx1 = trans(localGetSupportingVertex(localAxis));
//	btVector3 vtx2 = trans(localGetSupportingVertex(-localAxis));
//
//	minProj = vtx1.dot(dir);
//	maxProj = vtx2.dot(dir);
//	witnesPtMax = vtx2;
//	witnesPtMin = vtx1;
//	
//	if(minProj > maxProj)
//	{
//		btScalar tmp = minProj;
//		minProj = maxProj;
//		maxProj = tmp;
//		witnesPtMax = vtx1;
//		witnesPtMin = vtx2;
